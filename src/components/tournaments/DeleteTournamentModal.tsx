...
export default function DeleteTournamentModal() {
  ...
  const deleteTournamentId = queryParams.get("deleteTournament")!;
  const show = deleteTournamentId ? true : false;
  ...
  const handleForm = async (formData: CheckPasswordForm) => {
    ...
    await deleteTournamentMutation.mutateAsync(deleteTournamentId);
  };
            ...
            >
              <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-16">
                ...
                <p className="text-xl font-bold">
                  Confirma la eliminación del torneo {""}
